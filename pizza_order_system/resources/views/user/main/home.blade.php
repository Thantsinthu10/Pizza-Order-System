            ...
            <div class="row px-xl-5">
                ...
                <div class="col-lg-3 col-md-4">
                    ...
                    <div class="bg-light p-4 mb-30">
                        <form>
                            <div class=" d-flex align-items-center justify-content-between bg-black text-white px-3 py-1 mb-3">
                ...
                <div class="col-lg-9 col-md-8">
                    <div class="row pb-3">
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <div>
                                    <a href="{{ route('user#cartList') }}">
                                        <button type="button" class="btn bg-black rounded text-white position-relative">
                        ...
                        <span class="row" id="dataList">
                           ...
                           <div class="col-lg-4 col-md-6 col-sm-6 pb-1" >
                              <div class="product-item bg-light mb-4" id="myForm">
                                  <div class="product-img position-relative overflow-hidden">
                                      <img class="img-fluid w-100" style="height: 50%" src="{{ asset('storage/'.$p->image) }}" alt="">
                           ...
                           @endforeach
                           @else
                               <p class="text-center shadow-sm text-black fs-5 col-6 offset-3 py-3">There is no product <i class="fa-solid fa-pizza-slice ms-2"></i></p>
                           @endif
                        </span>
                    </div>
                </div>
